...
class FacePreprocessor:
    """Applies Viola-Jones detection and crops a normalized grayscale face image."""
    ...
    def _detect_face(self, gray: np.ndarray) -> np.ndarray:
        ...
        return self._fallback_crop(gray)

    def _fallback_crop(self, gray: np.ndarray) -> np.ndarray:
